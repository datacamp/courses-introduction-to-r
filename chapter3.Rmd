...
*** =instructions
- Calculate the average Non-US revenue per movie. Assign this average to the `non_us_all` variable. In other words, take the average of all elements of the second column.
