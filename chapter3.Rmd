...
if (!exists("new_hope")){
  ...
  DM.result = list(FALSE, "Make sure that you assign the correct vector to 'new_hope'.");
  ...
  DM.result = list(FALSE, "Make sure that you assign the correct vector to 'empire_strikes'.");
  ...
  DM.result = list(FALSE, "Make sure that you assign the correct vector to 'return_jedi'.");
  ...
  DM.result = list(FALSE, "Did you assign the correct matrix containing the vector that holds all three movies to 'star_wars_matrix?");
} else {
...
if (!exists("box_office_all")){
  ...
  DM.result = list(FALSE, "Make sure that you assign the correct vector to 'box_office_all'.");
  ...
  DM.result = list(FALSE, "Make sure that you assign the correct vector to 'movie_names'.");
  ...
  DM.result = list(FALSE, "Make sure that you assign the correct vector to 'col_titles'.");
} else if (!exists("star_wars_matrix")){
  DM.result = list(FALSE, "Please make sure to define a variable 'star_wars_matrix'.");
  ...
  DM.result = list(FALSE, "Make sure that you assign the correct vector to 'star_wars_matrix'.");
...
if (!exists("star_wars_matrix")){
  ...
  DM.result = list(FALSE, "It looks like 'visitors' does not contain the correct value. Remember that operations on matrices are element-wise.");
} else {
	DM.result = list(TRUE, "Great! Continue to the next exercise.");
}
```
...
if (!exists("star_wars_matrix")){
  ...
  DM.result = list(FALSE, "It looks like 'visitors' does not contain the correct value. Remember that you can divide two matrices.");
  ...
  DM.result = list(FALSE, "It looks like 'average_us_visitor' does not contain the average of the US visitors.");
} else if (!exists("visitors")){
  DM.result = list(FALSE, "Please make sure to define a variable 'visitors'.");
} else if (!isTRUE(try(all.equal(average_non_us_visitor,mean(visitors[,2]))))){
  DM.result = list(FALSE, "It looks like 'average_non_us_visitor' does not contain the average of the non-US visitors.");
} else {
	DM.result = list(TRUE, "Great! Continue to the next exercise.");
}
```
