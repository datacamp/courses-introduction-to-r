...
You can construct a matrix in R with the [`matrix()`](http://www.rdocumentation.org/packages/base/functions/matrix) function. Consider the following example: te
...
test_object("all_wars_matrix", incorrect_msg = "Be sure to use the the function `rbind()` with 2 arguments: `star_wars_matrix` and `star_wars_matrix2`. You should end up with a matrix of the correct dimensions: 6 rows and 2 columns.")
test_what(
  expect_equal(
