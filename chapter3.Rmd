...
- `matrix(box_office, nrow = ..., by_row ...)` is a template of the solution for the second instruction.
...
*** =sct
```{r eval=FALSE}
msg = "Do not change anything about the preset variables `box_office_all`, `movie_names`, `col_titles` and `star_wars_matrix`!"
...
test_object("all_wars_matrix",
            ...
            incorrect_msg = "Did you use the `cbind()` function with the correct arguments?")
...
test_object("all_wars_matrix", 
            undefined_msg = "Please make sure to define a variable `all_wars_matrix`.",
            incorrect_msg = "Did you use the `rbind()` function with the correct arguments?")
