...
- Cette fois, sélectionnez les recettes autres que celles des US pour les deux premiers films de `all_wars_matrix`. Enregistrez le résultat sous `non_us_some`.
