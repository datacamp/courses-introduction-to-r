...
Assim como toda ação tem uma reação, todo `cbind()` tem um `rbind()`. (admitimos que somos muito ruins com metáforas). 
...
`@instructions`
Use `rbind()` para colar `star_wars_matrix` e `star_wars_matrix2`, nesta ordem. Atribua a matriz resultante a .
...
`@instructions`
- Divida `all_wars_matrix` por 5, obtendo o número de visitantes em milhões. Atribua a matriz resultante a .
