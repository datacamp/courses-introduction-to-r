...
star_wars_matrix2 <- matrix(box_office_all2, nrow=3, byrow=TRUE,  
                                dimnames=list(movie_names2,col_titles))
```
...
col_titles     <- c("US","non-US")
star_wars_matrix      <- matrix(box_office_all, nrow=3, byrow=TRUE, dimnames=list(movie_names,col_titles)) 
ticket_prices_matrix  <- matrix( c(5,7,6,8,7,9), nrow=3,byrow=TRUE,dimnames=list(movie_names,col_titles)) 
...
```{r eval=FALSE}
names  <- c("star_wars_matrix","ticket_prices_matrix","visitors",
            "average_us_visitor","average_non_us_visitor")
