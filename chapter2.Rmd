...
test_object("boolean_vector",
            undefined_msg = "Please make sure to define a variable `boolean_vector`.",
            incorrect_msg = "Make sure that you assign the correct values to `boolean_vector`. You don't need quotes around `TRUE` and `FALSE`! Also, make sure to adaopt the same order as listed in the instructions.")
success_msg("Perfect! Notice that adding a space behind the commas in the `c()` function improve the readability of your code. Let's practice some more with vector creation in the next exercise.")
```
...
test_object("poker_vector",
            undefined_msg = "Please make sure to define a variable `poker_vector`.",
            incorrect_msg = "Make sure that you assign the correct values to `poker_vector`.")
test_object("roulette_vector",
            undefined_msg = "Please make sure to define a variable `roulette_vector`.",
            incorrect_msg = "Make sure that you assign the correct values to `roulette_vector`.")
...
test_object("poker_vector",
            eq_condition = "equal",
            incorrect_msg = "Make sure that you assign the correct names vector to `poker_vector`.")
test_object("roulette_vector",
            eq_condition = "equal",
            incorrect_msg = "Make sure that you assign the correct names vector to `roulette_vector`.")
...
test_object("days_vector",
            undefined_msg = "Please make sure to define a variable `days_vector`.",
            incorrect_msg = "Make sure that you assign the correct vector to `days_vector`.")
test_object("poker_vector",
            eq_condition = "equal",
...
test_object("A_vector",
            undefined_msg = "Please make sure to define a variable `A_vector`.",
            incorrect_msg = "Make sure that you assign the correct vector to `A_vector`.")
test_object("B_vector",
            undefined_msg = "Please make sure to define a variable `B_vector`.",
            incorrect_msg = "Make sure that you assign the correct vector to `B_vector`.")
test_object("total_vector",
            undefined_msg = "Please make sure to define a variable `total_vector`.",
            incorrect_msg = "Make sure that `total_vector` contains the sum of `A_vector` and `B_vector`.")
...
test_object("total_daily", 
            incorrect_msg = "Make sure that you assign the sum of `poker_vector` and `roulette_vector` to `total_daily`.")
...
test_object("total_week",
            undefined_msg = "Please make sure to define a variable `total_week`.",
            incorrect_msg = "Make sure that you assign to `total_week` the sum of the other two total vectors.")
```
...
test_object("total_roulette",
            ...
            incorrect_msg = "Make sure that you assign to `total_roulette` the sum of the `roulette_vector`.")
test_object("answer",
            undefined_msg = "Please make sure to define a variable `answer`.",
...
test_object("poker_midweek", 
            undefined_msg = "Please make sure to define a variable `poker_midweek`.",
            incorrect_msg = "It looks like `poker_midweek` does not contain the correct values from `poker_vector`.")
...
test_object("average_midweek_gain", 
            undefined_msg = "Please make sure to define a variable `average_midweek_gain`.",
            incorrect_msg = "It looks like `average_midweek_gain` does not contain the mean of the correct selection of `poker_vector`.")
...
test_object("poker_winning_days",
            undefined_msg =  "Please make sure to define a variable `poker_winning_days`.",
            incorrect_msg =  "It looks like `poker_winning_days` does not contain the correct result. Remember that R uses element wise operations for vectors.")
success_msg("Good job! Continue to the next exercise.")
```
...
test_object("roulette_winning_days",
            undefined_msg = "Please make sure to define a variable `roulette_winning_days`.",
            incorrect_msg = "It looks like `roulette_winning_days` does not contain the correct result. Make sure that you use `roulette_vector`.")
