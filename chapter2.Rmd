...
if (!exists("Vegas")){
  ...
  DM.result = list(FALSE, "Make sure that you assign the correct value to 'Vegas'. Do not forget that R is case sensitive.");
} else {
...
In the previous exercises you probably experienced that it is boring and frustrating to type and retype information such as the days of the week. However, when you look at it from a higher perspective, there is a more efficient way to do this: assign the days of the week vector to a **variable**! 
...
It is mportant to know is that if you sum two vectors in R, it takes the element-wise sum. For example: `c(1,2,3)+c(4,5,6)` is equal to `c(1+4,2+5,3+6)` or `c(5,7,9)`. Let us try this first!
...
*** =instructions
- Calculate the total amount of money you have won/lost with roulette and assign to the variable `total_roulette`.
...
if (!exists("total_poker")){
  ...
  DM.result = list(FALSE, "It looks like answer variable does not contain the correct answer. Make sure to carefully read the assignment.");
} else {
	DM.result = list(TRUE, "Good job! Continue to the next exercise.");
}
```
...
if (!exists("poker_wednesday")){
  ...
  DM.result = list(FALSE, "It looks like 'poker_wednesday' does not contain the correct value of the 'poker_vector'.");
} else {
	DM.result = list(TRUE, "Good job! Continue to the next exercise.");
}
```
...
if (!exists("poker_midweek")){
  ...
  DM.result = list(FALSE, "It looks like 'poker_midweek' does not contain the correct values from 'poker_vector'.");
} else {
  DM.result = list(TRUE, "Good job! Continue to the next exercise.");
}
```
...
if (!exists("roulette_selection_vector")){
  ...
  DM.result = list(FALSE, "It looks like 'roulette_selection_vector' does not contain the correct selection from 'roulette_vector'. Make sure to to use the right indices.");
} else {
  DM.result = list(TRUE, "Good job! Continue to the next exercise.");
}
```
...
if (!exists("average_midweek_gain")){
  ...
  DM.result = list(FALSE, "It looks like 'average_midweek_gain' does not contain the mean of the correct selection of 'poker_vector'.");
} else {
  DM.result = list(TRUE, "Good job! Continue to the next exercise.");
}
```
...
if (!exists("selection_vector")){
  ...
  DM.result = list(FALSE, "It looks like 'selection_vector' does not the correct result. Remember that R uses element wise operations for vectors.");
} else {
  DM.result = list(TRUE, "Good job! Continue to the next exercise.");
}
```
...
if (!exists("selection_vector")){
  ...
  DM.result = list(FALSE, "It looks like 'poker_winning_days' does not the correct result. Remember that R uses element wise operations for vectors.");
} else {
  DM.result = list(TRUE, "Good job! Continue to the next exercise.");
}
```
...
*** =instructions
- Assign the amount that you made on the days you ended positively for roulette to the variable `roulette_winning_days`.
...
if (!exists("selection_vector")){
  ...
  DM.result = list(FALSE, "It looks like 'selection_vector' does not the correct result. Make sure you use 'roulette_vector'.");
  ...
  DM.result = list(FALSE, "It looks like 'roulette_winning_days' does not the correct result. Make sure you use 'roulette_vector'.");
} else {
  DM.result = list(TRUE, "Good job! Continue to the next exercise.");
}
```
