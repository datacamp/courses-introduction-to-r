...
In the previous exercises you probably experienced that it is boring and frustrating to type and retype information such as the days of the week. However, when looking at it from a higher perspective, there is a more efficient way to do this: assign the days of the week vector to a **variable**! 
...
*** =hint
To get the mean of the vector poker, you can use `mean(poker_vector)`. You don't need the mean of all poker elements, but only of the first three days.
