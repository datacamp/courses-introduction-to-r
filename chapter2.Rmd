...
```{r eval=FALSE}
if (!exists("Vegas")){
  DM.result = list(FALSE, "Please make sure to define a variable <code>Vegas</code>.");
} else if (!isTRUE(try(all.equal(Vegas,"Here we go!")))){
  DM.result = list(FALSE, "Make sure that you assign the correct value to <code>Vegas</code>. Do not forget that R is case sensitive!");
} else {
...
On your way from rags to riches, you will make extensive use of vectors. Vectors are one-dimension arrays that can hold numeric data, character data, or logical data. In other words, a vector is a  simple tool to store data. For example, your daily gains and losses in the casinos. 
...
if (!exists("boolean_vector")){
  DM.result = list(FALSE, "Please make sure to define a variable <code>boolean_vector</code>.");
} else if (!isTRUE(try(all.equal(boolean_vector,c(TRUE,FALSE,TRUE))))){
  DM.result = list(FALSE, "Make sure that you assign the correct values to <code>boolean_vector</code>. The order matters!");
} else {
...
if (!exists("poker_vector")){
  DM.result = list(FALSE, "Please make sure to define a variable <code>poker_vector</code>.");
} else if (!isTRUE(try(all.equal(poker_vector,c(140,-50,20,-120,240))))){
  DM.result = list(FALSE, "Make sure that you assign the correct values to <code>poker_vector</code>.");
} else if (!exists("roulette_vector")){
  DM.result = list(FALSE, "Please make sure to define a variable <code>roulette_vector</code>.");
} else if (!isTRUE(try(all.equal(roulette_vector,c(-24,-50,100,-350,10))))){
  DM.result = list(FALSE, "Make sure that you assign the correct values to <code>roulette_vector</code>.");
} else {
...
if (!exists("poker_vector")){
  ...
  DM.result = list(FALSE, "Make sure that you assign the correct names vector to <code>poker_vector</code>.");
} else if (!exists("roulette_vector")){
  DM.result = list(FALSE, "Please make sure to define a variable <code>roulette_vector</code>.");
} else if (!isTRUE(try(all.equal(names(roulette_vector),c("Monday","Tuesday","Wednesday","Thursday","Friday"))))){
  DM.result = list(FALSE, "Make sure that you assign the correct names vector to <code>roulette_vector</code>.");
} else {
...
if (!exists("days_vector")){
  DM.result = list(FALSE, "Please make sure to define a variable <code>days_vector</code>.");
} else if (!isTRUE(try(all.equal(days_vector,c("Monday","Tuesday","Wednesday","Thursday","Friday"))))){
  DM.result = list(FALSE, "Make sure that you assign the correct vector to <code>days_vector</code>.");
} else if (!exists("poker_vector")){
  DM.result = list(FALSE, "Please make sure to define a variable <code>poker_vector</code>.");
} else if (!isTRUE(try(all.equal(names(poker_vector),days_vector)))){
  DM.result = list(FALSE, "Make sure that you assign the variable <code>days_vector</code> to the names of <code>poker_vector</code>.");
} else if (!exists("roulette_vector")){
  DM.result = list(FALSE, "Please make sure to define a variable <code>roulette_vector</code>.");
} else if (!isTRUE(try(all.equal(names(roulette_vector),days_vector)))){
  DM.result = list(FALSE, "Make sure that you assign the <code>days_vector</code> to the names of <code>roulette_vector</code>.");
} else {
	DM.result = list(TRUE, "Good job! Continue to the next exercise.");
}
```
...
It is important to know is that if you sum two vectors in R, it takes the element-wise sum. For example: `c(1,2,3)+c(4,5,6)` is equal to `c(1+4,2+5,3+6)` or `c(5,7,9)`. Let us try this first!
...
```{r eval=FALSE}
if (!exists("A_vector")){
  DM.result = list(FALSE, "Please make sure to define a variable <code>A_vector</code>.");
} else if (!isTRUE(try(all.equal(A_vector,c(1,2,3))))){
  DM.result = list(FALSE, "Make sure that you assign the correct vector to <code>A_vector</code>.");
} else if (!exists("B_vector")){
  DM.result = list(FALSE, "Please make sure to define a variable <code>B_vector</code>.");
} else if (!isTRUE(try(all.equal(B_vector,c(4,5,6))))){
  DM.result = list(FALSE, "Make sure that you assign the correct vector to <code>B_vector</code>.");
} else if (!exists("total_vector")){
  DM.result = list(FALSE, "Please make sure to define a variable <code>total_vector</code>.");
} else if (!isTRUE(try(all.equal(total_vector,A_vector + B_vector)))){
  DM.result = list(FALSE, "Make sure that <code>total_vector</code> contains the sum of <code>A_vector</code> and <code>B_vector</code>.");
} else {
	DM.result = list(TRUE, "Good job! Continue to the next exercise.");
}
```
...
if (!exists("days_vector")){
  ...
  DM.result = list(FALSE, "Please make sure to define a variable <code>total_daily</code>.");
} else if (!isTRUE(try(all.equal(total_daily,poker_vector + roulette_vector)))){
  DM.result = list(FALSE, "Make sure that you assign the sum of <code>poker_vector</code> and <code>roulette_vector</code> to <code>total_daily</code>.");
} else {
	DM.result = list(TRUE, "Good job! Continue to the next exercise.");
}
```
...
A function that helps you to answer this question is `sum()`. It calculates the sum of all elements of a vector. For example, to calculate the total amount of money you have lost/won with poker you do: `total_poker = sum(poker_vector)`.
...
if (!exists("total_poker")){
  DM.result = list(FALSE, "Please make sure to define a variable <code>total_poker</code>.");
} else if (!isTRUE(try(all.equal(total_poker,sum(poker_vector))))){
  DM.result = list(FALSE, "Make sure that you assign to <code>total_poker</code> the sum of the <code>poker_vector</code>.");
} else if (!exists("total_roulette")){
  DM.result = list(FALSE, "Please make sure to define a variable <code>total_roulette</code>.");
} else if (!isTRUE(try(all.equal(total_roulette,sum(roulette_vector))))){
  DM.result = list(FALSE, "Make sure that you assign to <code>total_roulette</code> the sum of the <code>roulette_vector</code>.");
} else if (!exists("total_week")){
  DM.result = list(FALSE, "Please make sure to define a variable <code>total_week</code>.");
} else if (!isTRUE(try(all.equal(total_week,total_roulette + total_poker)))){
  DM.result = list(FALSE, "Make sure that you assign to <code>total_week</code> the sum of the other two total vectors.");
} else {
	DM.result = list(TRUE, "Good job! Continue to the next exercise.");
}
```
...
Ooops, it seems like you are losing money :-s. Time to rethink and adapt your strategy! This will require some deeper analysis... 
...
if (!exists("total_poker")){
  ...
  DM.result = list(FALSE, "Please make sure to define a variable <code>answer</code>.");
} else if (!isTRUE(try(all.equal(answer,total_poker > total_roulette)))){
  DM.result = list(FALSE, "It looks like the answer variable does not contain the correct answer. Make sure to read the assignment carefully.");
} else {
	DM.result = list(TRUE, "Good job! Continue to the next exercise.");
}
```
...
```{r eval=FALSE}
if (!exists("poker_wednesday")){
  DM.result = list(FALSE, "Please make sure to define a variable <code>poker_wednesday</code>.");
} else if (!isTRUE(try(all.equal(poker_wednesday,poker_vector[3])))){
  DM.result = list(FALSE, "It looks like <code>poker_wednesday</code> does not contain the correct value of the <code>poker_vector</code>.");
} else {
	DM.result = list(TRUE, "Good job! Continue to the next exercise.");
}
```
...
To select multiple elements from a vector, you can add square brackets at the end of it. You can indicate between the brackets what element should be selected. For example: suppose you want to select the first and the fifth day of the week: use the vector `c(1,5)` between the square brackets: `poker_vector[c(1,5)]`. Thus, you select here the first and the fifth element of `poker_vector`.
...
```{r eval=FALSE}
if (!exists("poker_midweek")){
  DM.result = list(FALSE, "Please make sure to define a variable <code>poker_midweek</code>.");
} else if (!isTRUE(try(all.equal(poker_midweek,poker_vector[ c(2,3,4) ])))){
  DM.result = list(FALSE, "It looks like <code>poker_midweek</code> does not contain the correct values from <code>poker_vector</code>.");
} else {
  DM.result = list(TRUE, "Good job! Continue to the next exercise.");
}
```
...
```{r eval=FALSE}
if (!exists("roulette_selection_vector")){
  DM.result = list(FALSE, "Please make sure to define a variable <code>roulette_selection_vector</code>.");
} else if (!isTRUE(try(all.equal(roulette_selection_vector,roulette_vector[2:5])))){
  DM.result = list(FALSE, "It looks like <code>roulette_selection_vector</code> does not contain the correct selection from <code>roulette_vector</code>. Make sure to to use the right indices.");
} else {
  DM.result = list(TRUE, "Good job! Continue to the next exercise.");
}
```
...
*** =instructions
- Calculate your average poker gains during the first three days of the week by selecting these elements with the help of the names. Assign this value to `average_midweek_gain`. You can use `mean(vector_name)` to get the average of a vector.
...
```{r eval=FALSE}
if (!exists("average_midweek_gain")){
  DM.result = list(FALSE, "Please make sure to define a variable <code>average_midweek_gain</code>.");
} else if (!isTRUE(try(all.equal(average_midweek_gain,mean( poker_vector[c("Monday","Tuesday","Wednesday")] ))))){
  DM.result = list(FALSE, "It looks like <code>average_midweek_gain</code> does not contain the mean of the correct selection of <code>poker_vector</code>.");
} else {
  DM.result = list(TRUE, "Good job! Continue to the next exercise.");
}
```
...
```{r eval=FALSE}
if (!exists("selection_vector")){
  DM.result = list(FALSE, "Please make sure to define a variable <code>selection_vector</code>.");
} else if (!isTRUE(try(all.equal(selection_vector,poker_vector > 0)))){
  DM.result = list(FALSE, "It looks like <code>selection_vector</code> does not the correct result. Remember that R uses element wise operations for vectors.");
} else {
  DM.result = list(TRUE, "Good job! Continue to the next exercise.");
}
```
...
if (!exists("selection_vector")){
  ...
  DM.result = list(FALSE, "Please make sure to define a variable <code>poker_winning_days</code>.");
} else if (!isTRUE(try(all.equal(poker_winning_days,poker_vector[selection_vector])))){
  DM.result = list(FALSE, "It looks like <code>poker_winning_days</code> does not the correct result. Remember that R uses element wise operations for vectors.");
} else {
  DM.result = list(TRUE, "Good job! Continue to the next exercise.");
}
```
...
*** =instructions
- Assign the amount that you made on the days that you ended positively for roulette to the variable `roulette_winning_days`.
...
if (!exists("selection_vector")){
  ...
  DM.result = list(FALSE, "It looks like <code>selection_vector</code> does not the correct result. Make sure that you use <code>roulette_vector</code>.");
} else if (!exists("roulette_winning_days")){
  DM.result = list(FALSE, "Please make sure to define a variable <code>roulette_winning_days</code>.");
} else if (!isTRUE(try(all.equal(roulette_winning_days,roulette_vector[selection_vector])))){
  DM.result = list(FALSE, "It looks like <code>roulette_winning_days</code> does not the correct result. Make sure that you use <code>roulette_vector</code>.");
} else {
  DM.result = list(TRUE, "Good job! Continue to the next exercise.");
}
```
