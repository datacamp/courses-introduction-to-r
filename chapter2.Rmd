...
test_object("boolean_vector",
            ...
            incorrect_msg = "Make sure that you assign the correct values to <code>boolean_vector</code>. You don't need quotes around `TRUE` and `FALSE`! Also, make sure to adaopt the same order as listed in the instructions.")
