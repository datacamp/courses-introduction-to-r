...
This command test for every element of the vector if the condition stated by the comparison operator is `TRUE` or `FALSE`.

*** =instructions
- Check if which elements in `poker_vector` are positive (i.e. > 0) and assign this to `selection_vector`. 
