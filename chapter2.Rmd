...
if (!exists("selection_vector")){
  ...
  DM.result = list(FALSE, "It looks like 'selection_vector' does not the correct result. Make sure that you use 'roulette_vector'.");
  ...
  DM.result = list(FALSE, "It looks like 'roulette_winning_days' does not the correct result. Make sure that you use 'roulette_vector'.");
} else {
  DM.result = list(TRUE, "Good job! Continue to the next exercise.");
}
```
