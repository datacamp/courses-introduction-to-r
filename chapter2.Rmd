...
test_object("total_roulette",
            ...
            incorrect_msg = "Make sure that you assign to <code>total_roulette</code> the sum of the <code>roulette_vector</code>.")
test_object("answer",
            undfefined_msg = "Please make sure to define a variable <code>answer</code>.",
...
test_object("selection_vector", 
            ...
            incorrect_msg = "It looks like <code>selection_vector</code> does not the correct result. Remember that R uses element wise operations for vectors.")
...
test_object("poker_winning_days",
            ...
            incorrect_msg =  "It looks like <code>poker_winning_days</code> does not the correct result. Remember that R uses element wise operations for vectors.");
success_msg("Good job! Continue to the next exercise.")}
```
...
test_object("roulette_winning_days",
            ...
            incorrect_msg = "It looks like <code>roulette_winning_days</code> does not the correct result. Make sure that you use <code>roulette_vector</code>.")
