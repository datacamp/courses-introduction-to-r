...
A data frame has the variables of a data set as columns and the observations as rows. An R data frame is the same concept as an SQL database table, or a SAS dataset, or a MATLAB table, or an SPSS table.
