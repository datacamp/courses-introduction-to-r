...
test_output_contains("head(mtcars)", 
                     incorrect_msg = "Make sure that you use the `head()` function on `mtcars`.")
...
*** =hint
The `data.frame(col1, col2, col3,...)` function takes as arguments the vectors that will become the columns of the data frame. The columns in this case are (in this order): `planets`, `type`, `diameter`, `rotation` and `rings`.
...
test_function("str", "object", incorrect_msg = "Make sure that you use the `str()` function on `planets_df`.")
...
Sometimes you want to select all elements of a row or column. To do this, you can use the following. `my_data_frame[1, ]` selects all elements of the first row. Let us now apply this technique on `planets_df`!
...
test_object("closest_planets_df",
            undefined_msg = "Please make sure to define a variable `closest_planets_df`.",
            incorrect_msg = "Did you select the first three rows of `planets_df`?")
test_object("furthest_planets_df",
            undefined_msg = "Please make sure to define a variable `furthest_planets_df`.",
            incorrect_msg = "Make sure that you select the last three rows of `planets_df`.")
...
test_object("furthest_planets_diameter",
            undefined_msg = "Please make sure to define a variable `furthest_planets_diameter`.",
            incorrect_msg = "Make sure that you select the last six rows and only the `diameter` column.")
...
test_object("rings_vector",
            undefined_msg = "Please make sure to define a variable `rings_vector`.",
            incorrect_msg = "It looks like `rings_vector` does not contain all the element of the `ring` variable of the `planets_df`.")
...
test_object("planets_with_rings_df",
            undefined_msg = "Please make sure to define a variable `planets_with_rings_df`.",
            incorrect_msg = "It looks like `planets_with_rings_df` does not contain all the data of the planets with rings.")
test_student_typed("rings_vector", not_typed_msg = "Please use `rings_vector` to subset the data frame!")
...
*** =hint
`subset(planets_df, subset = ...)` is part of the solution.
...
test_object("small_planets_df",
            undefined_msg = "Please make sure to define a variable `small_planets_df`.",
            incorrect_msg = "It looks like `small_planets_df` does not contain all the correct subset of planets_df.")
test_function("subset", incorrect_msg = "Please be sure to use the `subset` function!")
...
``` 
will give you the ordering of the variable diameter from largest to smallest. This is what you should assign to positions. Use the variable positions then to select from the data frame `planets_df`!
...
success_msg("Wonderful! What does the resulting data frame look like? Type `largest_first_df` in the console and find out! This exercise concludes the chapter on data frames. Remember that data frames are extremely important in R, you will need them all the time. Another very often used data structure is the list. This will be the subject of the next chapter!")
```
