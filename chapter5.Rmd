...
`@hint`
Just submit the answer and witness the magic!
...
`@instructions`
Experiment with the [`order()`](http://www.rdocumentation.org/packages/base/functions/order) function in the console. Submit answer when you are ready to continue.
