...
test_output_contains('planets_df[rings_vector, ]', incorrect_msg = "Have you correctly adapted the code to select _all_ columns for the planets that have rings? Remember: to select all columns, you simply have to leave the columns part inside the `[ ]` empty: `[rings_vector, ]`.")
