...
test_output_contains('planets_df[rings_vector, ]', incorrect_msg = "Have you correctly adapted the code to select _all_ columns for the planets that have rings? You can use `planets_df[rings_vector, ]`.")
...
test_output_contains("planets_df[positions,]",
                     incorrect_msg = "Have you correctly sorted `planets_df` and printed out the result? Use `planets_df[positions, ]`.")
