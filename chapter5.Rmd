...
test_student_typed("rings_vector", not_typed_msg = "Please use <code>rings_vector</code> to subset the data frame!")
...
test_function("subset", incorrect_msg = "Please be sure to use the <code>subset</code> function!")
