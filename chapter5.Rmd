...
title: Data frames
description: >-
  De meeste gegevenssets waarmee je werkt, worden opgeslagen als data frames.
  Aan het einde van dit hoofdstuk kun je een data frame maken, interessante
  delen selecteren en een data frame ordenen op basis van bepaalde variabelen.
---
