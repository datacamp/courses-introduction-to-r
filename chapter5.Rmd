...
Un marco de datos tiene las variables de un conjunto de datos como columnas y las observaciones como filas. Este será un concepto familiar para quienes procedan de distintos paquetes de software estadístico, como SAS o SPSS.
