...
Un marco de datos tiene las variables de un conjunto de datos como columnas y las observaciones como filas. Este será un concepto familiar para quienes estén acostumbrados a utilizar diferentes paquetes de software estadístico, como SAS o SPSS.
...
¿Qué has aprendido exactamente en los ejercicios anteriores? Seleccionaste un subconjunto de un marco de datos (`planets_df`) en función de si se cumplía o no una determinada condición (anillos o no anillos), y conseguiste extraer todos los datos relevantes. ¡Impresionante! A estas alturas, probablemente la NASA ya esté coqueteando con tu currículum ;-). 
