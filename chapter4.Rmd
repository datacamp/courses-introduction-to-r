...
You've already seen that nominal categorical variables are created with [`factor()`](http://www.rdocumentation.org/packages/base/functions/factor). To create ordinal categorical variables, you use [`ordered()`](http://www.rdocumentation.org/packages/base/functions/factor).
...
* Compare the two sexes, testing if `male` is greater than (`>`) `female`.
