...
A good example of a categorical variable is the variable 'Gender'. A human individual can either be "Masculine" or "Feminine", making abstraction of inter-sexes. So here "Masculine" and "Feminine" are, in a simplified sense, the two values of the categorical variable "Gender", and every observation can be assigned to either the value "Masculine" of "Feminine".
