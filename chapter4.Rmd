...
title       : Factors
description : Very often, data falls into a limited number of categories. For example, human hair color may be categorized as black/brown/blonde/red. In R, categorical data is stored in factors. Given the importance of these factors in data analysis, you should start learning how to create, subset and compare them now!
