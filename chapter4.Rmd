...
[`summary()`](http://www.rdocumentation.org/packages/base/functions/summary) is an important utility function that gives you a quick overview of the contents of a variable:
