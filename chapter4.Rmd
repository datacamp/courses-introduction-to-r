...
* Recreate the factor, using the `levels` argument to `factor()` to spcify `"Male"` as the first level and `"Female"` as the second level. Store this in `factor_survey_vector_mf`.
