...
test_object("factor_gender_vector",
            undefined_msg = "Please make sure to define a variable `factor_gender_vector`.",
...
test_object("factor_survey_vector", eq_condition = "equal",
            undefined_msg = msg,
            incorrect_msg = paste("Did you assign the correct factor levels to `factor_survey_vector`?",
...
*** =sct
```{r eval=FALSE}
msg = "Do not change anything about the first four lines that define `survey_vector` and `factor_survey_vector`."
test_object("survey_vector", undefined_msg = msg, incorrect_msg = msg)
test_object("factor_survey_vector", eq_condition = "equal", undefined_msg = msg, incorrect_msg = msg)
test_function("summary", "object", 
              incorrect_msg = c("Did you call the summary function on the `survey_vector`?",
                                "Did you call the summary function on the `factor_survey_vector`?"))
...
test_object("speed_vector", 
            undefined_msg = "Please make sure to define a variable `speed_vector`.",
...
test_correct({
  test_object("factor_speed_vector", eq_condition = "equal",
              undefined_msg = "Please make sure to define a variable `factor_speed_vector`.",
