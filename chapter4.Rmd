...
test_or(test_error(msg_err),
        test_object("theory", eval=FALSE)
    )

test_object("theory", undefined_msg = msg_undef, eval=FALSE)
test_object("theory", incorrect_msg = msg_incor)
...
test_object("speed_vector",
            incorrect_msg = "`speed_vector` should be a vector with 5 entries, on for each analyst's speed rating. Don't use capital letters; R is case sensitive!")
