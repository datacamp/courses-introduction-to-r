...
test_output_contains("my_apples + my_oranges",
                     incorrect_msg = "The output does not contain the result of adding `my_apples` and `my_oranges`. Try again")
...
test_object("my_numeric", 
            undefined_msg = "Please make sure to define a variable `my_numeric`.",
            incorrect_msg = "Make sure that you assign the correct value to `my_numeric.`")
test_object("my_character",
            undefined_msg = "Please make sure to define a variable `my_character`.",
            incorrect_msg = "Make sure that you assign the correct value to `my_character`. Do not forget the quotes.")
...
*** =instructions
Complete the code in the editor and print the classes of `my_numeric`, `my_character` and `my_logical` to the console. 
...
test_output_contains("class(my_numeric)",
                     incorrect_msg = "The output does not contain the class of `my_numeric`. Try again.")
test_output_contains("class(my_character)",
                     incorrect_msg = "The output does not contain the class of `my_character`. Give it another try.")
test_output_contains("class(my_logical)",
                     incorrect_msg = "The output does not contain the class of `my_logical`.")
