...
**Variables** let you store values so that you can later reuse them. The types of variable that can be created include vectors of numbers, matrices, and data frames &ndash; the latter are for storing spreadsheet-like data. You'll see some of the different types of variable throughout this course.
