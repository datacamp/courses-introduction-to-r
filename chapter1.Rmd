...
- Select `3 + 4` in the editor, then run the selection.
...
- Type `20918 %/% 11` to see how many times 11 goes into 20918 without going over.
...
test_output_contains("20918 %/% 11", incorrect_msg = "Did you try out the integer division example? Type `20918 %/% 11` on a new line.")
