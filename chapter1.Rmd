...
if (!(isTRUE(try(output_contains("2^5"))))) {
  DM.result = list(FALSE, "The exponentiation example is not correct. Make sure to carefully read the instructions.");
...
Remember, if you want to assign a number or an object to a variable in R, you can make use of the assignment operator `=`.
...
if (!exists("my_oranges")) {
  ...
  DM.result = list(FALSE, "The output does not contain the result of adding 'my_apples' and 'my_oranges'.");
...
Common knowledge tells you not to add apples and oranges. But hey, that is what you just did, didn't you :-)? The `my_apples` and `my_oranges` variables both contained a number in the previous exercise. The `+` operator works with numeric variables in R. Suppose you really tried to add "apples" and "oranges", and assigned a text value to the variable `my_oranges` (see the editor), you would be trying to assign the addition of a numeric and a character variable to the variable `my_fruit`. This is not possible.
...
if (!exists("my_numeric")) {
  ...
  DM.result = list(FALSE, "Make sure that you assign the correct value to 'my_character'. Do not forget the quotes.");
...
Remember when you added `5 + "six"` and got an error due to a mismatch in data types? You can avoid such embarrassing situations by checking the data type of a variable beforehand. You can do this as follows: `class(some_variable_name)`.
...
if (!(isTRUE(try(output_contains("class(my_numeric)"))))) {
  DM.result = list(FALSE, "The output does not contain the class of 'my_numeric'.");
} else if (!(isTRUE(try(output_contains("class(my_character)"))))) {
  DM.result = list(FALSE, "The output does not contain the class of 'my_character'.");
} else if (!(isTRUE(try(output_contains("class(my_logical)"))))) {
  DM.result = list(FALSE, "The output does not contain the class of 'my_logical'.");
} else {
