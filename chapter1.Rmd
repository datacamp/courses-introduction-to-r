...
**Variables** let you store values so that you can reuse them later. The types of variable that can be created include vectors of numbers, matrices, and data frames &ndash; the latter are for storing spreadsheet-like data. You'll see some of the different types of variable throughout this course.

You can **assign** a value 4 to a variable named `my_var` with the command
