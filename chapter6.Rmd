...
- Create a list, called `departed_list`, that contains the `movie_title`, `movie_actors`, reviews data frame as `reviews_fd`, and the average review score as `avg_review`, and print it.
...
`@sample_code`
```{r}
# Use the table from exercise description to define the comments and scores vectors
...
# Create and print a list, called `departed_list`
