...
- Combine the `comments` and `scores` vectors into a data frame called `reviews_df`. 
...
# Combine comments and scores into the reviews_df data frame
...
comments <- c("I would watch it again", "Amazing!", "A bit violent, but I liked it", "Leonardo DiCaprio's best movie", "Great plot")
