...
Earlier in the chapter, you created a list using various sources. Now, you'd like to add more information to the data frame that is part of that list to add other reviews of the movie and gain more insights into what viewers thought of it.

You found reviews of another movie! You want to create a list, similar to the list you used earlier in the chapter, that contains the movie name, the main actors in the movie, and a data frame containing reviews of the movie.  a more recent movie - the departed 

The `movie_title` and `movie_actors` have been preloaded for you. 
Names are clear from instructions 

`@instructions`
- Create a vector that corresponds to each review shown in the table.
- Add the vectors containing the new reviews to the existing `departed_reviews` data frame. 
- Use the reviews that are part of your list to calculate the average rating viewers gave the movie.
...
`@sample_code`
```{r}
# Add the reviews to the vectors below
...
# Create a list of the movie name, reviews data frame, and the average review and print it
