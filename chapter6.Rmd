...
- **Data frames** (two-dimensional objects) Holds numeric, character or logical values. Within a column all elements have the same data type, but different columns can be of different data type.
...
if (!exists("my_list")){
  ...
  DM.result = list(FALSE, "It looks like 'my_list' does not contain the correct elements.");
} else {
	DM.result = list(TRUE, "Great! Continue to the next exercise.");
}
```
...
if (!exists("my_list")){
  ...
  DM.result = list(FALSE, "It looks like 'my_list' does not contain the correct naming for the components.");
} else {
	DM.result = list(TRUE, "Great! Continue to the next exercise.");
}
```
...
if (!exists("shining_list")){
  ...
  DM.result = list(FALSE, "It looks like 'shining_list' does not contain the correct components.");
} else {
	DM.result = list(TRUE, "Great! Continue to the next exercise.");
}
```
...
if (!exists("last_actor")){
  ...
  DM.result = list(FALSE, "Looks like 'last_actor' does not equal the last actor.");
  ...
  DM.result = list(FALSE, "It looks like 'second_review' does not contain all the information regarding the second review.");
} else {
	DM.result = list(TRUE, "Great! Continue to the next exercise.");
}
```
...
Being proud of your first list, you shared it with the members of your movie hobby club. However, one of the senior members, a guy named M. McDowell, noted that you forgot to add the release year. Given your ambitions to become next years president of the club, you decide to add this information to the list. 
...
if (!exists("shining_list")) {
  ...
  DM.result = list(FALSE, "It looks like 'shining_list' does not contain the year item.");
} else {
  DM.result = list(TRUE, "Great! Continue to the next exercise.");
}
```
