...
Often, your list will be build out of numerous elements and components. Therefore, getting a single element, multiple elements, or a component out of it is not always straightforward. 
...
To conveniently add elements to lists, you use the concatenate function `c()`: 
