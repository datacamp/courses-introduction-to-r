...
This creates a list with components that are named `name1`, `name2`, and so on. Notice that you don't need to wrap the names in quotes (as long as the name is also a valid variable name &ndash; otherwise you do).
