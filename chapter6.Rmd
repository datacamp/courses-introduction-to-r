...
test_object("my_list",
            undefined_msg = "Please make sure to define a variable `my_list`.",
...
test_object("shining_list",
            undefined_msg = "Please make sure to define a variable `shining_list`.",
...
test_object("last_actor", 
            undefined_msg = "Please make sure to define a variable `last_actor`.",
            incorrect_msg = "Looks like `last_actor` does not equal the last actor.")
test_object("second_review",
            undefined_msg = "Please make sure to define a variable `second_review`.",
            incorrect_msg = "It looks like `second_review` does not contain all the information regarding the second review.")
...
test_object("shining_list_full",
            undefined_msg = "Please make sure to define a variable `shining_list_full`.",
            incorrect_msg = "It looks like `shining_list_full` does not contain all the correct elements. It should contain the `year` (1980) as well!")
test_object("shining_list_full", eq_condition = "equal",
            incorrect_msg = "It looks like `shining_list_full` does not contain the correct naming for all the components.");
test_function("str", "object", incorrect_msg = "Make sure to inspect the structure of `shining_list_full`.")
