...
You found reviews of another, more recent Jack Nicholson movie: The Departed! You want to create a list, similar to the list you created earlier in the chapter, that contains different pieces of information about the movie. You'd like to start by creating a data frame of the reviews in the table below. 
...
The `movie_title` and `movie_actors` objects have been preloaded for you and contain the name of the movie and a list of the actors in the movie. 
...
- Create a list, called `departed_list`, that contains the movie name, reviews data frame, and the average review, and print it.
...
# Create and print a list of the movie name, actors, reviews_df, and avg_review, called departed_list
